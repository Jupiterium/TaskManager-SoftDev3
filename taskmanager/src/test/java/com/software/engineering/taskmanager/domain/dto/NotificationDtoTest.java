...
class NotificationDtoTest {
    ...
    void notificationDto_CreatesRecordWithAllFields() {
        ...
        NotificationDto dto = new NotificationDto(id, title, message, type, taskId, taskTitle, isRead, created);
    ...
    void notificationDto_WithNullValues_HandlesNulls() {
        NotificationDto dto = new NotificationDto(null, "Title", "Message", NotificationType.CUSTOM_REMINDER, null, null, false, LocalDateTime.now());
    ...
    void notificationDto_Equality_WorksCorrectly() {
        ...
        NotificationDto dto1 = new NotificationDto(id, "Title", "Message", NotificationType.TASK_DUE_SOON, null, null, false, created);
        NotificationDto dto2 = new NotificationDto(id, "Title", "Message", NotificationType.TASK_DUE_SOON, null, null, false, created);
        NotificationDto dto3 = new NotificationDto(UUID.randomUUID(), "Different", "Message", NotificationType.TASK_DUE_SOON, null, null, false, created);
    ...
    void notificationDto_ToString_ContainsAllFields() {
        NotificationDto dto = new NotificationDto(UUID.randomUUID(), "Title", "Message", NotificationType.TASK_ASSIGNED, UUID.randomUUID(), "Task", true, LocalDateTime.now());
