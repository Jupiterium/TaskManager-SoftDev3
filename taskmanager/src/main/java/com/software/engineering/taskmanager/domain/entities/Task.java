...
public class Task {
    @Id
    //everytime when create a task with null id, JPA will generate a UUID for the task and
    //that will be its UUID
    ...
    @ManyToOne(fetch = FetchType.LAZY) // Meaning the Task List won't be actually called from the database until it's actually needed
